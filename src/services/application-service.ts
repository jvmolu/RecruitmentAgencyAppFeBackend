...
export class ApplicationService {
	...
	public static async createApplication(
		applicationData: Omit<ApplicationType, "createdAt" | "updatedAt">,
		client?: PoolClient
		...
		if (!validationResult.success) {
			const zodError: ZodParsingError =
				validationResult.error as ZodParsingError;
	...
	public static async findByParams(
		...
		const validationResult =
			ApplicationSearchSchema.partial().safeParse(applicationFields);
		if (!validationResult.success) {
			const zodError: ZodParsingError =
				validationResult.error as ZodParsingError;
			zodError.errorType = "ZodParsingError";
		...
		return await this.applicationRepository.findByParams(
			validationResult.data,
			searchParamsValidationResult.data as ApplicationSearchParams
		);
	}
	...
	public static async updateApplications(
		...
		const updateValidationResult = ApplicationSchema.partial().safeParse(
